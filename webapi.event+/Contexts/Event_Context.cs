...
namespace webapi.event_.Contexts
{
    ...
    public class Event_Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=tcp:eventserverlucca.database.windows.net,1433;Initial Catalog=eventdatabaselucca;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;User Id=eventserverlucca;pwd=Senai@134;");
